...
The projects in this folder are not presented only as finished applications. They are also used as a source of testing and documentation evidence.
...
This folder is being rebuilt as part of my new portfolio direction. Some project folders may initially contain placeholder README files and will be expanded as artefacts are cleaned, documented, and linked from the portfolio website.
